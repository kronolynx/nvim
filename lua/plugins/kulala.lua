...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function()
    ...
    vim.keymap.set('n', '<leader>rt', '<cmd>lua require("kulala").toggle_view()<cr>', { desc = "Toggle Body/headers" })
    vim.keymap.set('n', '<leader>rc', '<cmd>lua require("kulala").copy()<cr>', { desc = "Copy as curl" })
    vim.keymap.set('n', '<leader>rp', '<cmd>lua require("kulala").from_curl()<cr>', { desc = "Paste from curl" })
    vim.keymap.set('n', '<leader>rg', '<cmd>lua require("kulala").download_graphql_schema()<cr>',
      { desc = "Download GraphQL rchema" })
    ...
    vim.keymap.set('n', '<leader>rq', '<cmd>lua require("kulala").close()<cr>', { desc = "Close window" })
    vim.keymap.set('n', '<leader>rr', '<cmd>lua require("kulala").replay()<cr>', { desc = "Replay the last request" })
    vim.keymap.set('n', '<leader>rS', '<cmd>lua require("kulala").show_stats()<cr>', { desc = "Show stats" })
  end
})
